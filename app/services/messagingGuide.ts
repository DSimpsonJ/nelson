...
export const MOMENTUM_MESSAGES = {
    ...
    // SOLID RANGE (70-79%)
    solid_stable: "Solid performance. This is exactly where you should be.",
    solid_rising: "Momentum building. You're in the zone.",
    solid_falling: "Still solid. Keep the pattern going.",
    
    // BUILDING RANGE (50-69%)
    building_stable: "Gaining traction. A few more solid days and you're on track.",
    building_rising: "Momentum forming. Keep going.",
    building_falling: "Building takes time. Stay with it.",
    ...
    zero: "Your momentum: 0%. Let's build from here.",
  ...
  export function getPatternWarningMessage(badDaysInWindow: number): string {
    ...
    if (badDaysInWindow >= 3) {
      return "The pattern shifted. Time to reset and rebuild.";
    }
   ...
   */
  export const DAY_ONE_BEFORE_CHECKIN = "Your momentum: 0%. Let's build from here.";
  ...
  export const CELEBRATION_MESSAGES = {
    ...
    thirty_days_80_plus: "30 days of excellence. You've proven the pattern.",
  ...
  export const CTA_MESSAGES = {
    ...
    // After missed day(s)
    after_absence: "The experiment needs you. Check in today.",
    
    // Long absence (7+ days)
    long_absence: "Ready to rebuild? Start with today's check-in.",
