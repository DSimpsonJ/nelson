import { privacyPolicyHTML } from "./policyContent.js";

export const metadata = {
  title: "Privacy Policy — Nelson",
  description: "How Nelson collects, uses, and protects your data.",
};
