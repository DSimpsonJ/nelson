      ...
      >
        ...
        >
          ...
          <p className="text-gray-600 text-sm mb-6">
            Ready to focus on the road ahead?
          </p>
        </motion.div>
        ...
        >
          <button
  onClick={() => {
    console.log("🔵 Continue button clicked, onClose:", onClose);
    if (onClose) onClose();
  }}
...
{shareable && (
  <button
    onClick={handleShare}
    disabled={isSharing}
    className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 rounded-xl transition-colors disabled:opacity-50"
  >
    {isSharing ? "Shared! ✓" : "Share This Win"}
  </button>
)}
        </motion.div>
